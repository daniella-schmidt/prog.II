...
// Criando biblioteca (agrega todos os componentes)
$biblioteca = new Biblioteca();

// Adicionando usuários e livros (agregação)
...
// Realizando empréstimos através da biblioteca
try {
...
<head>
    <meta charset="UTF-8">
    <title>Biblioteca - Sistema com Agregação</title>
    <style>
        body {
